...
function grupoSistema($grupo) {
      ...
      switch ($grupo) {
                    ...
                    case 1:   return "Gestão";   break;
                    case 2:   return "Moderador";   break;
                    case 3:   return "Fiscalização";   break;
                    case 4:   return "Atendimento";   break;
                    case 5:   return "Estagiário";   break;
                    case 6:   return "Consultas";   break;
                    case 7:   return "Fornecedor";   break;
                    case 8:   return "Administrativo";   break;
                  }
...
function retornoEmergencial($retorno) {
      ...
      switch ($retorno) {
        ...
        case 1:   return 'de acordo com os critérios de elegibilidade do Benefício Municipal você não atende aos requisitos necessários para receber o benefício';   break;
        case 2:   return "já realizou a consulta e não é elegível para receber o benefício";   break;
        case 3:   return "consta na lista de beneficiários contemplados com o benefício e na data de 01/05/2021 terá seu benefício disponibilizado";   break;
        case 4:   return 'já realizou a consulta e está contemplado. O benefício será disponibilizado em 01/05/2021.';   break;
...
function emergencialBOX($retorno) {
      ...
      switch ($retorno) {
                    ...
                    case 1:   return '<div class="alert alert-danger alert-dismissible">';   break;
                    case 2:   return '<div class="alert alert-warning alert-dismissible">';   break;
                    case 3:   return '<div class="alert alert-success alert-dismissible">';   break;
                    case 4:   return '<div class="alert alert-info alert-dismissible">';   break;
                  }
...
function generoAdolescente($sexo) {
      ...
      switch ($sexo) {
                    ...
                    case 1:   return "Feminino";   break;
                    case 2:   return "Masculino";   break;
                  }
