          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0"><strong>DADOS DO DOCUMENTO</strong></h5>
              </div>
              <div class="card-body">
                <div class="row">
                    <div class="col-12 text-center">
                      <span class="text-primary h5"><strong>TIPO DOCUMENTO:&nbsp;</strong></span><span class="text-muted h5"><?php echo $dadosDocumento["Tipo"]; ?></span>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <span class="text-primary h5"><strong>Nº:&nbsp;</strong></span><span class="text-muted h5">
                    <?php echo $dadosDocumento["Documento"]; ?>/<?php echo $dadosDocumento["Ano"]; ?></span>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <span class="text-primary h5"><strong>ORIGEM:&nbsp;</strong></span><span class="text-muted h5"><?php echo $dadosDocumento["Origem"]; ?></span>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <span class="text-primary h5"><strong>DESTINO:&nbsp;</strong></span><span class="text-muted h5"><?php echo $dadosDocumento["Destino"]; ?></span>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <span class="text-primary h5"><strong>Recebido:&nbsp;</strong></span><span class="text-muted h5"><?php echo $dadosDocumento["Entrada"]; ?>&nbsp; - &nbsp;<?php echo $dadosDocumento["Hora"]; ?></span>
                    </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-12">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-12 h6 text-muted"><?php echo today(); ?></div>
                    </div>
                <br>
                <br>
                    <div class="row text-center">
                    ...
                    <div class="row text-center">
                        <div class="col-12 h6 text-muted"><?php echo getAgenteNome(); ?></div>
                    </div>
                </div>
              </div>
        </div>
