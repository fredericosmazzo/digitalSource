              ...
              <div class="card-body">
                <table id="grupoSistema" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td style="width: 50px; text-align: center; font-size: 10px;">
                      <?php if( menu($value1["idgrupo"],tabelaGrupo($value1["idgrupo"]), 'Protocolo')!=0 ){ ?>

                      <button type="button" class="btn-sm btn-success" data-toggle="modal" data-target="#modalRemovePermissao" data-menu="Protocolo" data-controle="2" data-nomegrupo="Protocolo" data-idgrupo="<?php echo $value1["idgrupo"]; ?>" data-tabela='<?php echo tabelaGrupo($value1["idgrupo"]); ?>'>PROTOCOLO</button>
                      <?php }else{ ?>

                      <button type="button" class="btn-sm btn-danger" data-toggle="modal" data-target="#modalNovaPermissao" data-menu="Protocolo" data-controle="2" data-nomegrupo="Protocolo" data-idgrupo="<?php echo $value1["idgrupo"]; ?>" data-tabela='<?php echo tabelaGrupo($value1["idgrupo"]); ?>'>PROTOCOLO</button>
                      <?php } ?>

                    </td>
                    <td style="width: 50px; text-align: center; font-size: 10px;">
                      <?php if( menu($value1["idgrupo"],tabelaGrupo($value1["idgrupo"]), 'Beneficio')!=0 ){ ?>

                      <button type="button" class="btn-sm btn-success" data-toggle="modal" data-target="#modalRemovePermissao" data-menu="Beneficio" data-controle="2" data-nomegrupo="Beneficio" data-idgrupo="<?php echo $value1["idgrupo"]; ?>" data-tabela='<?php echo tabelaGrupo($value1["idgrupo"]); ?>'>BENEFÍCIO</button>
                      <?php }else{ ?>

                      <button type="button" class="btn-sm btn-danger" data-toggle="modal" data-target="#modalNovaPermissao" data-menu="Beneficio" data-controle="2" data-nomegrupo="Beneficio" data-idgrupo="<?php echo $value1["idgrupo"]; ?>" data-tabela='<?php echo tabelaGrupo($value1["idgrupo"]); ?>'>BENEFÍCIO</button>
                      <?php } ?>

                    </td>
                    <td style="width: 50px; text-align: center; font-size: 10px;">
                      <?php if( menu($value1["idgrupo"],tabelaGrupo($value1["idgrupo"]), 'Cacem')!=0 ){ ?>

                      <button type="button" class="btn-sm btn-success" data-toggle="modal" data-target="#modalRemovePermissao" data-menu="Cacem" data-controle="2" data-nomegrupo="Cacem" data-idgrupo="<?php echo $value1["idgrupo"]; ?>" data-tabela='<?php echo tabelaGrupo($value1["idgrupo"]); ?>'>CACEM</button>
                      <?php }else{ ?>

                      <button type="button" class="btn-sm btn-danger" data-toggle="modal" data-target="#modalNovaPermissao" data-menu="Cacem" data-controle="2" data-nomegrupo="Cacem" data-idgrupo="<?php echo $value1["idgrupo"]; ?>" data-tabela='<?php echo tabelaGrupo($value1["idgrupo"]); ?>'>CACEM</button>
                      <?php } ?>
