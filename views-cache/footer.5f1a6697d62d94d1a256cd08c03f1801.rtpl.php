...
<script>
  $(function () {
    ...
    var donutChartCanvas = $('#graficoAtendidas').get(0).getContext('2d')
    var donutData        = {
      labels: [<?php $counter1=-1;  if( isset($totalNumerosAtendidosData) && ( is_array($totalNumerosAtendidosData) || $totalNumerosAtendidosData instanceof Traversable ) && sizeof($totalNumerosAtendidosData) ) foreach( $totalNumerosAtendidosData as $key1 => $value1 ){ $counter1++; ?>'<?php echo $value1["dia"]; ?>',<?php } ?>],
      datasets: [
        {
          data: [<?php $counter1=-1;  if( isset($totalNumerosAtendidosData) && ( is_array($totalNumerosAtendidosData) || $totalNumerosAtendidosData instanceof Traversable ) && sizeof($totalNumerosAtendidosData) ) foreach( $totalNumerosAtendidosData as $key1 => $value1 ){ $counter1++; ?>'<?php echo $value1["total"]; ?>',<?php } ?>],
          backgroundColor : ['#f56954', '#00a65a', '#f39c12', '#00c0ef', '#3c8dbc', '#d2d6de' , '#7B68EE' , '#FF4500' , '#FF00FF'],
        }
      ]
    }
    var donutOptions     = {
...
<script>
  $(function () {
    ...
    var donutChartCanvas = $('#graficoNaoAtendidas').get(0).getContext('2d')
    var donutData        = {
      labels: [<?php $counter1=-1;  if( isset($totalNumerosNaoAtendidosData) && ( is_array($totalNumerosNaoAtendidosData) || $totalNumerosNaoAtendidosData instanceof Traversable ) && sizeof($totalNumerosNaoAtendidosData) ) foreach( $totalNumerosNaoAtendidosData as $key1 => $value1 ){ $counter1++; ?>'<?php echo $value1["dia"]; ?>',<?php } ?>],
      datasets: [
        {
          data: [<?php $counter1=-1;  if( isset($totalNumerosNaoAtendidosData) && ( is_array($totalNumerosNaoAtendidosData) || $totalNumerosNaoAtendidosData instanceof Traversable ) && sizeof($totalNumerosNaoAtendidosData) ) foreach( $totalNumerosNaoAtendidosData as $key1 => $value1 ){ $counter1++; ?>'<?php echo $value1["total"]; ?>',<?php } ?>],
          backgroundColor : ['#f56954', '#00a65a', '#f39c12', '#00c0ef', '#3c8dbc', '#d2d6de','#7B68EE' , '#FF4500' , '#FF00FF'],
        }
      ]
    }
...
<script>
  $(function () {
    ...
    var donutChartCanvas = $('#graficoLigacoesDatas').get(0).getContext('2d')
    var donutData        = {
      labels: [<?php $counter1=-1;  if( isset($totalLigacoesData) && ( is_array($totalLigacoesData) || $totalLigacoesData instanceof Traversable ) && sizeof($totalLigacoesData) ) foreach( $totalLigacoesData as $key1 => $value1 ){ $counter1++; ?>'<?php echo $value1["dia"]; ?>',<?php } ?>],
      datasets: [
        {
          data: [<?php $counter1=-1;  if( isset($totalLigacoesData) && ( is_array($totalLigacoesData) || $totalLigacoesData instanceof Traversable ) && sizeof($totalLigacoesData) ) foreach( $totalLigacoesData as $key1 => $value1 ){ $counter1++; ?>'<?php echo $value1["total"]; ?>',<?php } ?>],
          backgroundColor : ['#f56954', '#00a65a', '#f39c12', '#00c0ef', '#3c8dbc', '#d2d6de','#7B68EE' , '#FF4500' , '#FF00FF'],
        }
      ]
    }
...
<script>
$('#modalNovoLocal').on('show.bs.modal', function (event) {
  var button = $(event.relatedTarget) // Button that triggered the
  // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
  // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
  var modal = $(this)
  modal.find('.modal-title').text('Inclusão de Local de Protocolo')

})
</script>
<script>
$('#modalNovoTipo').on('show.bs.modal', function (event) {
  var button = $(event.relatedTarget) // Button that triggered the
  // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
  // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
  var modal = $(this)
  modal.find('.modal-title').text('Inclusão de Tipo de Documento')

})
</script>

<script>
$('#modalEditarLocal').on('show.bs.modal', function (event) {
  var button = $(event.relatedTarget) // Button that triggered the
  var iddestino = button.data('iddestino')
  var destino = button.data('destino')
  // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
  // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
  var modal = $(this)
  modal.find('.modal-title').text('Inclusão de Local de Protocolo')
  modal.find('#iddestino').val(iddestino)
...
$('#modalEditarTipo').on('show.bs.modal', function (event) {
  ...
  modal.find('#tipodocumento').val(tipodocumento)
})
</script>
<script>
/*
