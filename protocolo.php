...
$app->get('/admin/protocolo/inicio', function() { // PÁGINA INICIAL
	...
	$page->setTpl("protocolo-inicio", array(
...
$app->get('/admin/protocolo/relatorio/:documento', function($documento) { // PÁGINA INICIAL
...
$app->post('/admin/protocolo/configuracoes/local', function() { // EXCLUIR CARGO
...
$app->post('/admin/protocolo/configuracoes/doc', function() { // EXCLUIR CARGO
